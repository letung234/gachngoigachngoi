...
export default function AdminLayout() {
  ...
  return (
    <div className='admin-layout flex bg-cement-light'>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-30 h-screen w-64 transform overflow-y-auto bg-earth transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${
      ...
      >
        ...
        <div className='flex items-center justify-between border-b border-earth-light p-4'>
          ...
          <button
            ...
            className='rounded-md p-1 text-cream hover:bg-earth-light lg:hidden'
          >
        ...
        <header className='admin-header border-b border-gray-200 bg-white shadow-sm'>
          <div className='flex items-center justify-between px-4 py-4 lg:px-6'>
            <button
              ...
              className='rounded-lg bg-gray-100 p-2 text-earth transition-all hover:bg-gray-200 lg:hidden'
